...
📊 Project Overview
This project provides an end-to-end financial performance analysis of a solar energy asset. The study focuses on profitability, cash flow, and Return on Investment (ROI), while evaluating the impact of operational maintenance on overall earnings.
...
ETL Process: Data ingestion and cleaning using Python (Pandas).

Database Management: SQL-based validation and aggregation for structured querying.

Financial Modeling: Calculation of custom KPIs, including Wealth Velocity and Cumulative ROI.

Impact Evaluation: Comparative analysis of pre-and-post maintenance performance.
